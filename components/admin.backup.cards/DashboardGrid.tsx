  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      <MetricCard
        ...
        icon={<Users className="w-10 h-10" weight="regular" />}
      />
      ...
      <MetricCard
        ...
        icon={<CheckSquare className="w-10 h-10" weight="regular" />}
      />
      ...
      <MetricCard
        ...
        icon={<Lightning className="w-10 h-10" weight="regular" />}
      />
      ...
      <MetricCard
        ...
        icon={<ChartLine className="w-10 h-10" weight="regular" />}
      />
    </div>
  );
}